<script lang="ts">
	...
	import { helpModal } from "$lib/store"
	$:visible = $helpModal
</script>

<button
	class="overlay w-full fixed top-0 left-0 right-0 bottom-0 bg-opacity-60 bg-black p-6 hidden justify-center items-center"
	class:visible
    on:click={()=>$helpModal = false}
>
